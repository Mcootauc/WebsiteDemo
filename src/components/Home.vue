<template>
    <div class="grid grid-cols-4 gap-5">
        ...
        <label class="inline-flex items-center cursor-pointer">
            ...
            <span
                ...
                >Toggle selected only</span
            >
        </label>

        <Datepicker range lang="en" v-model="selectedDate" />
    </div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
            <thead
                class="text-xs text-gray-700 uppercase bg-white-50 dark:bg-white-700 dark:text-gray-400"
            >
                <tr>
...
export default {
    ...
    data() {
        ...
        }; //flag to trigger properties selection
    },
    methods: {
        toggleDetails(index) {
